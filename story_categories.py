...
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/1.2/*.txt')
...
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/1.3/*.txt')
for book in modified_book_words:
    final_words_modify3, final_words_modify4 = modified_book_words[book]
    list1dot3.extend(final_words_modify4)
cat_list['1.3'] = list1dot3
   
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/1.5/*.txt')
for book in modified_book_words:
    final_words_modify3, final_words_modify4 = modified_book_words[book]
    list1dot5.extend(final_words_modify4)
cat_list['1.5'] = list1dot5
    
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/1.6/*.txt')
for book in modified_book_words:
    final_words_modify3, final_words_modify4 = modified_book_words[book]
...
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/1.8-1.9-2/*.txt')
for book in modified_book_words:
    final_words_modify3, final_words_modify4 = modified_book_words[book]
    list1dot8to2.extend(final_words_modify4)
cat_list['1.8-1.9-2'] = list1dot8to2  
  
modified_book_words = book_tot_modify_read.book_tot_modify('./StoryCorpus_copy/2-3/*.txt')
for book in modified_book_words:
    final_words_modify3, final_words_modify4 = modified_book_words[book]
