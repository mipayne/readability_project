...
for sent in mlu_ready_list:
    for tuple_trip in sent:
        word = tuple_trip[0]
        lem_word = tuple_trip[1]
        pos_tag = tuple_trip[2]
        if pos_tag == 'NNS':
            NNS_list.append(tuple_trip)
        if pos_tag == 'VBN':
            VBN_list.append(tuple_trip)
        if pos_tag == 'VBD':
            VBD_list.append(tuple_trip)
        if pos_tag == 'VBZ':
            VBZ_list.append(tuple_trip)
        if pos_tag == 'VBG':
            VBG_list.append(tuple_trip)
        if pos_tag == 'POS':
            POS_list.append(tuple_trip)
        if pos_tag == 'WP$':
            WP_list.append(tuple_trip)
        if lem_word == 'be':
            be_list.append(tuple_trip)
